        ...
        <div style={{position:"relative",padding:"50px",display:"flex",justifyContent:"center",alignItems:"center",gap:"40px",minHeight:"100vh",overflow:"hidden"}}>
          ...
          <div style={{background:"rgb(255,255,255)",borderRadius:"10px",padding:"40px 30px", color:"rgb(33,33,33)",textAlign:"center"}}>
            ...
            <TextField
              ...
              variant="outlined"
            />
            <Button variant="contained" onClick={connect} style={{margin:"0px 15px", padding:"13px 25px", border:"none",borderRadius:"8px",fontSize:"16px"}}>
              Connect
            </Button>
          </div>
        </div>
            ...
            <div className="chatRoom">
              <div className="chatContainer">
                <div className="chatHead">
                  <h1>Chat</h1>
                  <Button onClick={closeChat} variant="outlined" color="error">
                    Close
                  </Button>
                </div>
                <hr />
